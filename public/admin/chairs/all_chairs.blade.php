...
<div class="page-content">
   <div class="">
      <!-- page title -->
      @include('admin.includes.page_title', ['title'=>'الفعالية','supTitle' => 'الكراسي'])
                        ...
                        <div class="col-sm-3 col-lg-3">
                           ...
                           <select name="chair_category" class="form-control" id="filter_chair_category">
                              ...
                              @endforeach
								...
								<!-- chair_status -->
                        <div class="col-sm-3 col-lg-3">
                           <label for="filter_chair_status" class="col-form-label">حالة الكرسي</label>
                           <select name="chair_status" class="form-control" id="filter_chair_status">
                              <option value="">الكل</option>
...
$(document).ready(function () {
   ...
   //    var id = $(this).attr('data');
	// 	var url = "{{ route('edit_invited', [':id', ':day_id']) }}";
   ...
   $('#filter_button').on('click', function (event) {
      ...
      var chair_status = $('#filter_chair_status').val();
      var chair_category_id = $('#filter_chair_category').val();
      var day_id = $('#filter_day_id').val();
      
      var url= "{{ route('all_chairs') }}";
      var params = `name=${name}&chair_status=${chair_status}&chair_category_id=${chair_category_id}&day_id=${day_id}`;
      url = url + "?" + params;
