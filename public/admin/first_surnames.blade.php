...
<div class="page-content">
   <div class="container-fluid">
      <!-- page title -->
      @include('admin.includes.page_title', ['title'=>'لوحة التحكم','supTitle' => 'اللقب الأول'])
         ...
         <div class="modal-body">
            ...
            <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
               ...
               <div class="form-group row mb-3">
                  <label for="name" class="col-sm-3 col-form-label">اللقب الأول</label>
                  <div class="col-sm-9">
...
$(document).ready(function () {
   ...
   $(document).on('click', '.edit', function () {
      ...
      $.ajax({
         url: "{{ route('first-surname.index') }}" + '/' + id + '/edit',
         dataType: "json",
   ...
   $('#ok_button').click(function () {
      $.ajax({
         url: "{{ route('first-surname.index') }}" + '/' + record_id,
         beforeSend: function () {
