...
<div class="page-content">
   <div class="">
      <!-- page title -->
      @include('admin.includes.page_title', ['title'=>'لوحة التحكم','supTitle' => 'الدعوات العامة'])
               ...
               <div class="card">
                  <div class="card-body green_back">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <!-- order_status -->
                        <div class="col-sm-3 col-lg-3">
                           <label for="filter_order_status" class="col-form-label">حالة الطلب</label>
                           <select name="order_status" class="form-control" id="filter_order_status">
                              <option value="">الكل</option>
                        ...
                        @if($days)
                           <div class="col-sm-3 col-lg-3">
                              <label for="filter_source" class="col-form-label">الفعالية</label>
...
$(document).ready(function () {
   ...
   // Show tabel
   load_invitation("{{ route('invitations.index') }}");
   ...
   $('#filter_button').on('click', function (event) {
      ...
      var order_status = $('#filter_order_status').val();
      var day_id = $('#filter_day_id').val();
      
      var url= "{{ route('invitations.index') }}";
      var params = `name=${name}&email=${email}&mobile=${mobile}&category_id=${category_id}&source=${source}&order_status=${order_status}&day_id=${day_id}`;
      url = url + "?" + params;
