...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #fff;" leftmargin="0" dir="rtl">
<!-- 100% body table -->
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <h1 style="color:#7ac0bb; font-weight:500; margin:0;font-size:25px;font-family:'FrutigerLTArabic-75Black',sans-serif;">شكرا لك
                                    </h1>
                                    ...
                                    <br>
                                    <h5 style="color:#455056; font-weight:500; margin:0;font-size:15px;font-family:'FrutigerLTArabic-75Black',sans-serif;"> لتحميل بادج الدخول
                                    </h5>


                                    <a href="{{}}">
                                        <p  style="background:#7ac0bb;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">اضغط هنا</p></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="height:40px;">&nbsp;</td>
