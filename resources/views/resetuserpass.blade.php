...
<div style="text-align: center" class=" col-12">
    ...
    <input required class="form-control" name="pass" type="text"  >
@error('pass')


    <div class="alert alert-danger">{{ $message }}</div> @enderror
<label for="confirm_pass" > تأكيد كلمة المرور الجديدة </label>


    <br>
<input  class="form-control" name="confirm_pass" type="text"  >
...
class="next action-button lastAccept" id="lastAccept"
type="submit">حفظ
