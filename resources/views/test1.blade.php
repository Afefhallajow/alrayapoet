            ...
            <div class="card px-0 pb-0 mt-3 mb-3" style="margin-top:-3rem;border:none">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <img class="img desktopImg" src="{{ asset('old/public/images/logo2.jpeg') }}" alt="" style="height:200px;margin-bottom:30px">
                        <img class="img mobileImg" src="{{ asset('old/public/images/logo2.jpeg') }}" alt="" style="height:200px;margin-bottom:30px">
                ...
                <div id="details" style="text-align: center ">
                    <p style="font-size: 1.2rem;">التسجيل في ندوة مجلس شؤون الأسرة بتاريخ 19 مارس 2023م ضمن جلسات(سلسلة الحوارات الأسرية) تحت عنوان (العلاقة الحميمية والتوافق الزوجي)
                        <br>
                        ضيف الحوار : الدكتورة طرفة بنت عبدلله بنت معمر

                        <br>
                        الوقت من السابعة مساءً وحتى التاسعة مساءً
                    </p>
                    <label style=" font-size: 1.2rem;">      :شروط التسجيل </label>
                    <p style=" font-size: 1.2rem;">
                        سعودي الجنسية-
                        <br>
                        في سن الزواج-
                        <br>
                        أن يكون من سكان مدينة الرياض-</p>
                    <p style="font-size: 1.2rem;">
                        سيتم التواصل مع المقبولين *

                    </p>
                    <p style="font-size: 1.2rem">
                        سيتم إغلاق التسجيل في حال إكتمال العدد *
                    </p>
                            ...
                            <fieldset data-set="1">
                                <div class="form-card">
                                    ...
                                    <div class="row box">
                                        ...
                                        <div class="col-md-12">
                                            <label for="age" class="float-right"><span id="ps">(العمر يجب أن يكون بين 25 و 35) &nbsp</span><span style="color:red">*</span>العمر</label>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.error==false) {
                        $('form').html('<h2 style="direction:rtl;">تم تسجيلكم بنجاح..</h2>');
                        var ss=document.getElementById('details');
                        ss.style.display='none'
                        $('#textbody').html('<h2 style="direction:rtl;">  الحياة الزوجية والأسرية لدى الشباب والشابات(سلسلة الحوارات الأسرية)تحت عنوان (العلاقة الحميمية والتوافق الزوجي)</h2>');
                    }else {
                        if (response.count>=1){
