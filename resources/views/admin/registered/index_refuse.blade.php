                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a class="btn" data-toggle="modal" data-target="#exampleModal" style="font-weight:bold;float:right;font-size:1.2rem">  جدول المرفوضين</a>
                            </h6>
                            <div class="row">
                                  <div class="col-md-12">
...
@push('script')
    ...
    $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ route('getAllRegistereds',['regStatus' => 'refuse']) }}",
