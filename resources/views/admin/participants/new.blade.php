            ...
            <div class="card shadow mb-2">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <a class="btn" data-toggle="modal" data-target="#exampleModal" style="font-weight:bold;float:right;font-size:1.2rem"> بيانات المتأهلين </a>
                    </h6>
                    <div class="row">
                        <div class="col-md-12">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                var table = $('.yajra-datatable').DataTable({
                    ...
                    "pageLength": 36,
                    ajax: "{{ route('newall-participants') }}",
                    ...
                    columnDefs: [
...

                        {
                            targets: 13,
                            render: function (data, type, full) {
                                var text = full['passport'];
                                var id=full['id']
                                return '<a target="_blank" href="/download/passport/'+id+'"><i class="fa fa-download"><i></a>';
                            }
                        },
                            ...
                            render: function (data, type, full) {
                                ...
                                return (
                                    ...
                                    @endif
                                        ...
                                        '<a title="طلب إعادة" class="btn btn-primary btn-sm" style="text-align:right;margin: .1rem" href="/newgenerated_link/'+ id + '" id="resend" > طلب إعادة</a>'+
                                    @endcan
