...
<link href="/assets/register/hijri/css/bootstrap-datetimepicker.css" rel="stylesheet" />
<style>
...
<h1 class="first_msg" style="font-family: 'Tajawal', sans-serif;color:#fff">  </h1>
<h1 class="second_msg" style="font-family: 'Tajawal', sans-serif;color:#fff">  </h1>
</section>
...
<label for="member" style="font-family: 'Tajawal', sans-serif;color:#b79045">  بجودة عالية وبوضوح الحجم 500ميغا – المدةلاتقل عن60 ولاتزيد عن 120 ثانية  </label>
<div id="infos" style="display: none" class="alert alert-danger"><p id="info"></p> </div>
...
<input id="next" style="border-radius: 12px;" type="submit"  name="next" class="next action-button nextVisaBtn passportBtn" value="حفظ" />
</div>
...
<script src="/assets/register/hijri/js/momentjs.js"></script>
<script src="/assets/register/hijri/js/moment-with-locales.js"></script>
<script src="/assets/register/hijri/js/moment-hijri.js"></script>
<script src="/assets/register/hijri/js/bootstrap-hijri-datetimepicker.js"></script>
<script>
$.ajaxSetup({
headers: {
...
if(response=='fff')
{
var doc= document.getElementById('infos');
doc.style.display='block';
var doc1= document.getElementById('infos');
doc1.style.color='red';
var doc2= document.getElementById('next');
doc2.style.display='none';
$("#info").text('لم يتم حفظ الفيديو المدة يجب ان لاتقل عن60 ولا تزيد عن 120')
...
$('.first_msg').text('شكرا لك');
$('.second_msg').text('تمت العملية بنجاح');
},
error: function (err) {
alert('هناك خطأ في عملية رفع الفيديو');
console.log(err);
}
});
